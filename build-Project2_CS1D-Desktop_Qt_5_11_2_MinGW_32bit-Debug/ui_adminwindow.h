...
"	font-family:'Harmonia Sans Pro,Arial,sans-serif';"));
        ...
        spinBox_yearOpened_2 = new QSpinBox(UpdateStadium);
        spinBox_yearOpened_2->setObjectName(QStringLiteral("spinBox_yearOpened_2"));
        spinBox_yearOpened_2->setGeometry(QRect(360, 250, 251, 31));
        spinBox_yearOpened_2->setStyleSheet(QLatin1String("	border-radius:5px;\n"
"	border: 1px solid #cccccc;"));
        spinBox_yearOpened_2->setButtonSymbols(QAbstractSpinBox::NoButtons);
        spinBox_yearOpened_2->setMinimum(1900);
        spinBox_yearOpened_2->setMaximum(9999);
...
"	font-family:'Harmonia Sans Pro,Arial,sans-serif';"));
    ...
    void retranslateUi(QMainWindow *AdminWindow)
    {
        ...
        label_15->setText(QApplication::translate("AdminWindow", "Year Opened:", nullptr));
